<?php
  /*
    Template Name: PNW Mouse Trek Index
  */
 ?>
    ...
    <div class="container page-section">
      ...
      <div class="row intro-paragraph">
        <div class="col-md-8">
          <h2>Past Events</h2>
          <p class="intro">
            Multi-day Meet Up events that always included exclusive destinations and activities including visits to the Walt Disney Family Museum, Cruises, Disneyland and Walt Disney Studios.
          </p>
        </div>
      </div>
      <!-- Tiles -->
